...
; =================================================================================================
	...
	Else
	{
		Run "C:\Program Files\Notepad++\notepad++.exe" %strAHKFilename1%
		Sleep, 100
		Run "C:\Program Files\Notepad++\notepad++.exe" %strCVSFilename1%
		Sleep, 100
	}
...
/*
    ...
    ActiveWorkbook.Worksheets("Sheet1").Sort.SortFields.Add Key:=Range("A2:A1140" ), SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
    With ActiveWorkbook.Worksheets("Sheet1").Sort
        .SetRange Range("A1:AC1140")
        .Header = xlYes
        .MatchCase = False
